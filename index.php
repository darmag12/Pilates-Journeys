...
<body>
  <header class="header">
    ...
    <div class="header__middle">
      ...
      <a class="button" href="#classes">Schedule a Class</a>
    </div>
  </header>
  <!-- Begin About Section -->
  ...
  <section id="blog" class="blog">
    ...
    <div class="blog__moreblogs">
      <a href="" class="button button--tertiary" title="Link to all the blogs">More Blogs</a>
    </div>
  </section>
  <!-- End of Blog Section -->
  ...
  <footer id="footer" class="footer">
    <div class="footer__content">
      ...
      <a href="https://www.instagram.com/Pilatesjourneys/"><i class="fa-brands fa-instagram"></i> pilatesjourneys</a>
      <br>
      <br>
      <span class="footer__copyright">Copyright &copy; 2024 -
  ...
  <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/js/bootstrap.bundle.min.js"
    ...
    crossorigin="anonymous"></script>
  <script src="<?php include get_stylesheet_directory() . '/build/main.js'; ?>"></script>
</body>
